...
// Мокаем импорты
vi.mock('@/assets/images/maps/Map1/st/st1.png', () => ({ default: 'st1-mock.png' }));
vi.mock('@/assets/images/maps/Map1/st/st2.png', () => ({ default: 'st2-mock.png' }));
vi.mock('@/assets/images/maps/Map1/st/st3.png', () => ({ default: 'st3-mock.png' }));
vi.mock('@/assets/images/maps/Map1/st/st4.png', () => ({ default: 'st4-mock.png' }));
vi.mock('@/assets/images/maps/Map1/li/1.png', () => ({ default: 'li1-mock.png' }));
