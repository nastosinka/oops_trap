...
describe("TRAPS_BY_MAP Configuration", () => {
  ...
  describe("map2 traps", () => {
    ...
    it("should have correct Vue components for map2", () => {
      ...
      expect(map2Traps.map((trap) => trap.component)).toEqual(
        expectedComponents
      );
    });
  ...
  describe("map1 traps", () => {
    ...
    it("should have correct Vue components for map1", () => {
      ...
      expect(map1Traps.map((trap) => trap.component)).toEqual(
        expectedComponents
      );
    });
    ...
    it("should have grouped traps (trap2_1 and trap2_2)", () => {
      const trap2Group = map1Traps.filter((trap) =>
        trap.id.startsWith("trap2")
      );
    ...
    it("should have grouped traps (trap5_1 and trap5_2)", () => {
      const trap5Group = map1Traps.filter((trap) =>
        trap.id.startsWith("trap5")
      );
    ...
    it("should have grouped traps (trap8_1 and trap8_2)", () => {
      const trap8Group = map1Traps.filter((trap) =>
        trap.id.startsWith("trap8")
      );
