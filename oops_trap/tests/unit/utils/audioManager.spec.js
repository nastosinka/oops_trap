...
// Мокаем fetch
global.fetch = vi.fn();
global.setTimeout = vi.fn((fn, delay) => fn());
...
describe('AudioManager', () => {
    ...
    describe('load', () => {
        test('should load audio buffer', async () => {
            ...
            expect(manager.audioContext.decodeAudioData).toHaveBeenCalledWith(mockArrayBuffer);
    ...
    describe('playMusic', () => {
        ...
        test('should play music with correct parameters', async () => {
            ...
            const source = manager.audioContext.createBufferSource.mock.results[0].value;
