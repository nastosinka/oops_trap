...
describe('ResultsPage.vue', () => {
  ...
  describe('Навигация и взаимодействие', () => {
    it('обрабатывает возврат в лобби', async () => {
      ...
      expect(mockRouter.replace).toHaveBeenCalledWith('/lobby?id=test-lobby-123&mode=join');
    ...
    it('закрывает WebSocket при возврате в лобби', async () => {
      ...
      expect(mockUserStore.gameSocket.close).toHaveBeenCalledWith(1000, 'Leaving game');
    });
