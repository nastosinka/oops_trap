...
test.describe('CreateLobbyPage — FULL COVERAGE', () => {
  ...
  /* =========================
     STATS MODAL: EMPTY
  ========================= */
  test('Stats modal корректно обрабатывает пустую статистику', async ({ page }) => {
  ...
  /* =========================
     CREATE LOBBY: ERROR
  ========================= */
  test('ошибка при создании лобби отображается пользователю', async ({ page }) => {
  ...
  /* =========================
     MOBILE VIEW TEST
  ========================= */
  test('страница корректно работает на мобильном разрешении', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: 'Create a lobby' })).toBeVisible();
    await expect(page.getByRole('button', { name: 'Join the lobby' })).toBeVisible();
  ...
  test('CreateLobbyPage корректно отображается на планшете', async ({ page }) => {
  ...
  test('интерфейс адаптируется при изменении размеров окна', async ({ page }) => {
