          ...
          <div class="rules-text-content">
            ...
            <ul>
              <li>
                ...
                финиша до истечения времени. 
                Геймплей бегущего: стрелочки
                влево-вправо (или клавиши AD) для передвижения по земле; нажатие
                на W для прыжка; удержание клавиш WASD для перемещений
                по лианам и в воде, нажатие пробела для прыжка с лианы или воды.
              </li>
            </ul>
          </div>
        </div>
