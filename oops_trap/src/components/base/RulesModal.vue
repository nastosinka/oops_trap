      ...
      >
        ...
        <div v-if="activeSection === 'common'" class="accordion-content">
          <div class="rules-text-content">
            ...
            <li>
              на игру отводится определенное время (зависит от карты и от выбора
              создателя лобби)
            </li>
            <li>
              trapmaker нажимает на кнопочки и активирует динамические ловушки
              на карте (условие победы - ни один игрок не дошел до конца за
              отведенное время)
            </li>
            <li>
              runners бегут по карте, пытаясь выжить (можно умереть от
              статических и динамических ловушек, игра на этом для вас
              завершается, но вам видно оставшуюся катку в режиме зрителя) и
              добежать до конца за отведенное время (условие победы добежал до
              конца)
            </li>
          </div>
        </div>
      ...
      >
        ...
        <div v-if="activeSection === 'maps'" class="accordion-content">
          <div class="rules-text-content">
            ...
            <li>
              динамические ловушки - зоны, в которых активируются ловушки при
              нажатии кнопки мафией, кнопка и зона при этом уходят в кд и
              восстанавливается через время
            </li>
          </div>
        </div>
      </div>
